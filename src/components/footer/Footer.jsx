              ...
              <div className="footer-widget-inner">
                <h4 className="footer-heading d-flex align-items-center justify-content-between">
                  ...
                  <span className="d-md-none">
                    <svg className="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="#00234D" strokeWidth={1} strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="6 9 12 15 18 9" />
                    </svg>
                  </span>
                </h4>
                <ul className="footer-menu list-unstyled mb-0 d-md-block">
                  <li className="footer-menu-item"><a href="about-us.html">About us</a></li>
                  <li className="footer-menu-item"><a href="about-us.html">Press center</a></li>
                  <li className="footer-menu-item"><a href="blog.html">Our magazine</a></li>
                  <li className="footer-menu-item"><a href="about-us.html">Our group</a></li>
                  <li className="footer-menu-item"><a href="about-us.html">Work with us</a></li>
                </ul>
              </div>
            </div>
            <div className="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                ...
                <div className="footer-newsletter">
                  ...
                  <div className="newsletter-wrapper">
                    <form action="#" className="footer-newsletter-form d-flex align-items-center">
                      ...
                      <button className="footer-newsletter-btn" type="submit">SIGN
                        UP</button>
                    </form>
                  </div>
                  <div className="footer-social-wrapper">
                    <ul className="footer-social list-unstyled d-flex align-items-center flex-wrap mb-0">
                      <li className="footer-social-item">
                        <a href="#">
                          <svg className="icon icon-twitter" width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <li className="footer-social-item">
                        <a href="#">
                          <svg className="icon icon-facebook" width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <li className="footer-social-item">
                        <a href="#">
                          <svg className="icon icon-instagram" width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <li className="footer-social-item">
                        <a href="#">
                          <svg className="icon icon-tiktok" width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M13.2367 1C13.5336 3.55445 14.9591 5.0774 17.4375 5.23942V8.11251C16.0012 8.25292 14.7431 7.78307 13.2799 6.89739V12.2709C13.2799 19.0972 5.8393 21.2304 2.84795 16.3375C0.925716 13.189 2.10282 7.66426 8.26909 7.44284V10.4725C7.79933 10.5481 7.29717 10.667 6.83821 10.8236C5.46673 11.288 4.68919 12.1575 4.90518 13.6913C5.32094 16.6292 10.7097 17.4986 10.2615 11.7579V1.0054H13.2367V1Z" fill="#00234D" />
                          </svg>
                        </a>
                      </li>
                      <li className="footer-social-item">
                        <a href="#">
                          <svg className="icon icon-youtube" width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
