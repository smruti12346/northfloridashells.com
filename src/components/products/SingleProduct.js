                      ...
                      <div className="product-details ps-lg-4">
                        ...
                        <form className="product-form" action="#">
                          <div className="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                            <button type="submit" className="position-relative btn-atc btn-add-to-cart loader">ADD TO CART</button>
                          ...
                          <div className="buy-it-now-btn mt-2">
                            <button type="submit" className="position-relative btn-atc btn-buyit-now">BUY IT NOW</button>
                          </div>
                        </form>                   
                ...
                <div className="container">
                  <div className="tab-list product-tab-list">
                    <nav className="nav product-tab-nav">
                      <a className="product-tab-link tab-link active" href="#pdescription" data-bs-toggle="tab">Description</a>
                      <a className="product-tab-link tab-link" href="#pshipping" data-bs-toggle="tab">Shipping &amp; Returns</a>
                  ...
                  <div className="tab-content product-tab-content">
                    ...
                    <div id="pshipping" className="tab-pane fade">
                      <div className="desc-content">
                        ...
                        <p className="text_16 mb-4">The European law states that when an order is being returned, it is mandatory for the company to refund the product price and shipping costs charged for the original shipment. Meaning: one shipping fee is paid by us.</p>
                        <p className="text_16 mb-4">Standard Shipping: If you placed an order using "standard shipping" and you want to return it, you will be refunded the product price and initial shipping costs. However, the return shipping costs will be paid by you.</p>
                        <p className="text_16">Free Shipping: If you placed an order using "free shipping" and you want to return it, you will be refunded the product price, but since we paid for the initial shipping, you will pay for the return.</p>
                      </div>
                    </div>
                    <div id="pstyle" className="tab-pane fade">
                      <div className="desc-content">
                        <h4 className="heading_18 mb-3">Style with</h4>
                        <p className="text_16 mb-4">Please also bear in mind that shipping goods back and forth generates greenhouse gases that are accelerating climate change. We encourage you to choose your items carefully to avoid unnecessary return shipments.</p>
                        <p className="text_16 mb-4">You have to pay for return shipping if you want to exchange your product for another size or the package is returned because it has not been picked up at the post office.</p>
                      </div>
                    </div>
                    <div id="preview" className="tab-pane fade">
                      <div className="review-area accordion-parent">
                        ...
                        <div className="review-header d-flex justify-content-between align-items-center">
                          ...
                          <button className="text_14 bg-transparent text-decoration-underline write-btn" type="button">Write a review</button>
                        </div>
                        <div className="review-form-area accordion-child">
                          <form action="#">
                            ...
                            <fieldset>
                              ...
                              <textarea cols={30} rows={10} placeholder="Write your comments here" defaultValue={""} />
                            </fieldset>
                ...
                <div className="container">
                  ...
                  <div className="product-container position-relative">
                    <div className="common-slider" data-slick="{
                      ...
                      <div className="new-item" data-aos="fade-up" data-aos-duration={300}>
