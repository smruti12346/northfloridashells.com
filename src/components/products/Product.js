                      ...
                      <div className="row">
                          ...
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/9.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/1.jpg" alt="product-img" />
                              </a>
                          ...
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                ...
                                <img className="primary-img" src="assets/img/products/furniture/2.jpg" alt="product-img" />
                              </a>
                              <div className="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" className="action-card action-quickview" data-bs-toggle="modal">
                                  <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration={700}>
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/11.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/3.jpg" alt="product-img" />
                              </a>
                              <div className="product-badge">
                        ...
                        <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration={700}>
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/14.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/4.jpg" alt="product-img" />
                              </a>
                              <div className="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" className="action-card action-quickview" data-bs-toggle="modal">
                                  <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration={700}>
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/15.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/5.jpg" alt="product-img" />
                              </a>
                              <div className="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" className="action-card action-quickview" data-bs-toggle="modal">
                                  <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration={700}>
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/16.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/6.jpg" alt="product-img" />
                              </a>
                              <div className="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" className="action-card action-quickview" data-bs-toggle="modal">
                                  <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration={700}>
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/17.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/7.jpg" alt="product-img" />
                              </a>
                              <div className="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" className="action-card action-quickview" data-bs-toggle="modal">
                                  <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration={700}>
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/19.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/8.jpg" alt="product-img" />
                              </a>
                              <div className="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" className="action-card action-quickview" data-bs-toggle="modal">
                                  <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration={700}>
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/29.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/9.jpg" alt="product-img" />
                              </a>
                              <div className="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" className="action-card action-quickview" data-bs-toggle="modal">
                                  <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration={700}>
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/21.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/27.jpg" alt="product-img" />
                              </a>
                              <div className="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" className="action-card action-quickview" data-bs-toggle="modal">
                                  <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration={700}>
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/22.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/28.jpg" alt="product-img" />
                              </a>
                              <div className="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" className="action-card action-quickview" data-bs-toggle="modal">
                                  <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration={700}>
                          <div className="product-card">
                            <div className="product-card-img">
                              <a className="hover-switch" href="collection-left-sidebar.html">
                                <img className="secondary-img" src="assets/img/products/furniture/29.jpg" alt="product-img" />
                                <img className="primary-img" src="assets/img/products/furniture/23.jpg" alt="product-img" />
                              </a>
                              <div className="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" className="action-card action-quickview" data-bs-toggle="modal">
                                  <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="product-card-details">
                              <ul className="color-lists list-unstyled d-flex align-items-center">
                                <li><a href="javascript:void(0)" className="color-swatch swatch-black active" /></li>
                                <li><a href="javascript:void(0)" className="color-swatch swatch-cyan" /></li>
                                <li><a href="javascript:void(0)" className="color-swatch swatch-purple" />
                                </li>
                              </ul>
                              <h3 className="product-card-title">
                                <a href="collection-left-sidebar.html">Vita Lounge Chair</a>
                        ...
                        <div className="filter-related">
                          <div className="related-item d-flex">
                            <div className="related-img-wrapper">
                              <img className="related-img" src="assets/img/products/furniture/21.jpg" alt="img" />
                            </div>
                          ...
                          <div className="related-item d-flex">
                            <div className="related-img-wrapper">
                              <img className="related-img" src="assets/img/products/furniture/22.jpg" alt="img" />
                            </div>
                            <div className="related-product-info">
                              <h2 className="related-heading heading_18">
                          ...
                          <div className="related-item d-flex">
                            <div className="related-img-wrapper">
                              <img className="related-img" src="assets/img/products/furniture/23.jpg" alt="img" />
                            </div>
                            <div className="related-product-info">
                              <h2 className="related-heading heading_18">
